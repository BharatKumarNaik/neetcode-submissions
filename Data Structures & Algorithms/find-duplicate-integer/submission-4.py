class Solution:
    def findDuplicate(self, nums: List[int]) -> int:
        ...
        # if it's greater then mid, means there exist some values between low to mid.
        # which has duplicate values (remember mid here is representing like a window size, to which count of all nums val <= mid should match)
